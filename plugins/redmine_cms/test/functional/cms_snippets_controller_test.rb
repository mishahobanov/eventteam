...
class CmsSnippetsControllerTest < ActionController::TestCase
  ...
  def test_get_preview
    ...
    compatible_request :get, :preview, :id => @snippet
    assert_response 200
  end
  ...
  def test_get_edit
    @request.session[:user_id] = 1
    compatible_request :get, :edit, :id => @snippet
    assert_response 200
  end
