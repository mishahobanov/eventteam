...
unless ActionController::Base.included_modules.include?(RedmineCMS::Patches::ActionControllerPatch)
  ActionController::Base.send(:include, RedmineCMS::Patches::ActionControllerPatch)
end
